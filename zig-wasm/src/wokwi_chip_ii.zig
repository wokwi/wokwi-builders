...
pub const INPUT = 0;
pub const OUTPUT = 1;
pub const INPUT_PULLUP = 2;
pub const INPUT_PULLDOWN = 3;
pub const ANALOG = 4;
pub const OUTPUT_LOW = 16;
pub const OUTPUT_HIGH = 16;
pub const RISING = 1;
pub const FALLING = 2;
pub const BOTH = 3;
pub const PinId = i32;
...
pub extern fn pinInit(name: ?[*:0]u8, mode: u32) PinId;
...
pub extern fn uartWrite(dev: UARTDevId, buffer: ?[*:0]u8, count: u32) bool;
pub extern fn i2cInit(config: ?*I2CConfig) I2CDevId;
pub extern fn spiInit(config: ?*SPIConfig) SPIDevId;
pub extern fn spiStart(dev: SPIDevId, buffer: ?[*:0]u8, count: u32) callconv(.C) void;
pub extern fn spiStop(dev: SPIDevId) callconv(.C) void;
pub extern fn attrInit(name: ?[*:0]u8, default_value: f64) AttrId;
...
pub extern fn bufferRead(buffer: BufferId, offset: u32, data: ?[*:0]u8, data_len: u32) u32;
pub extern fn bufferWrite(buffer: BufferId, offset: u32, data: ?[*:0]u8, data_len: u32) u32;
pub extern fn debugPrint(message: ?[*:0]u8) callconv(.C) void;
